        ...
        $(
            impl FullOps for $ty {
                ...
                fn full_mul(self, other: $ty, carry: $ty) -> ($ty, $ty) {
                    ...
                    ((v >> (core::mem::size_of::<$ty>() * 8)) as $ty, v as $ty)
                }
                ...
                fn full_div_rem(self, other: $ty, borrow: $ty) -> ($ty, $ty) {
                    ...
                    let lhs = ((borrow as $bigty) << (core::mem::size_of::<$ty>() * 8)) | (self as $bigty);
    ...
    ($name:ident: type=$ty:ty, n=$n:expr) => {
        ...
        impl $name {
            ...
            pub fn get_bit(&self, i: usize) -> u8 {
                let digitbits = core::mem::size_of::<$ty>() * 8;
                let d = i / digitbits;
                let b = i % digitbits;
            ...
            pub fn mul_pow5(&mut self, mut e: usize) -> &mut $name {
                use core::mem;
                use crate::core_num::bignum::SMALL_POW5;
        ...
        impl core::fmt::Debug for $name {
            fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                ...
                let digitlen = (core::mem::size_of::<$ty>() * 8) / 4;
